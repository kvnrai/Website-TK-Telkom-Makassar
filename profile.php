...
<html lang="en">
  ...
  <body class="mt-5">
    ...
    <div class="jumbotron jumbotron-fluid" style="background-image: url(kayu.jpg); background-attachment: fixed; background-size: cover; background-repeat: no-repeat;">
      <div class="container text-center">
        <img src="icon.png" width="15%" class="rounded-circle img-thumbnail">
        <h1 class="display-4 mt-3" style="color: white;">TK Telkom Makassar</h1>
        <p class="ml13" class="lead" style="color: white;">BERMAIN DAN BELAJAR BERSAMA DI TK TELKOM MAKASSAR</p>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row mb-4">
        <div class="col text-center">
          <h2 style="color: black; font-size: 32px;">About</h2>
        </div>
      </div>
 ...
 <section id="sitem_pembelajaran" class="portofolio bg-light pb-4">
    <div class="container">
      <div class="row mb-4 pt-5 mb-5">
        <div class="col text-center">
          <h2 style="color: black; font-size: 32px;">Sistem Pembelajran</h2>
        </div>
      </div>
      ...
      <div class="row mb-4">
        <div class="col-md">
          <div class="card">
            ...
            <div class="card-body">
              <p class="card-text" style="color: black; text-align: center;">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            </div>
          </div>
        </div>
    ...
    <section id="daftar" class="daftar mb-4 mt-5 text-center">
      <div class="jumbotron" style="background-image: linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url(cover1.jpg); background-attachment: fixed; background-size: cover; background-repeat: no-repeat;">
        <h1 class="kata1" style="size: 30px; color: white;">Ayo Daftarkan Anak Anda<br>Sekarang!</h1>
        <p class="kata2" style="color: white;">Bermain dan Belajar Bersama TK Telkom Makassar</p>
        <a class="btn btn-danger btn-lg" href="ppdb.php" role="button">Pendaftaran PPDB</a>
      </div>
    </section>
      ...
      <section id="contact" class="contact mb-4">
        <div class="container">
          <div class="row pt-4 mb-4">
            <div class="col text-center">
              <h2  style="color: black; font-size: 32px;">Hubungi Kami</h2>
            </div>
          </div>
            ...
            <div class="col-lg-4">
              <div class="card text-white bg-danger mb-3 text-center">
                <div class="card-body">
                  ...
                  <p class="card-text" style="color: white;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                  tempor.</p>
                </div>
              </div>
              <ul class="list-group">
                <li class="list-group-item"><h1>Lokasi</h1></li>
                <li class="list-group-item">TK Telkom Makassar</li>
                <li class="list-group-item">Jln AP. Pettarani No.4</li>
                <li class="list-group-item">Makassar</li>
              </ul>
            </div>
            ...
            <div class="col-lg-6">
              <form>
                ...
                <div class="form-group">
                  ...
                  <textarea nama="pesan" id="pesan" class="form-control"></textarea>
                </div>
                <div class="form-group">
