  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-10 p-5 pt-2">
        ...
        <a href="form_tambah.php" class="btn btn-primary mb-3"><i class="fas fa-plus-square mr-2"></i> TAMBAH DATA SISWA</a>
        <table class="table table-striped table-bordered">
          <thead>
            <tr>
              ...
              <th colspan="3" scope="col">TIPE USER</th>
            </tr>
          </thead>
          <tbody>
            <?php 
            ...
            ?>
              <tr>
                ...
                <td><a href="edit.php?id=<?php echo $d['id']; ?>"><i class="fas fa-edit bg-success p-2 text-white rounded" data-toggle="tooltip" title="Edit"></i></a></td>
                <td><a href="proses_hapus.php?id=<?php echo $d['id']; ?>"><i class="fas fa-trash-alt bg-danger p-2 text-white rounded" data-toggle="tooltip" title="Delete"></i></a></td>
