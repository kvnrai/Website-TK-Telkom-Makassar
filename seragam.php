        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item active" href="seragam.php" style="background-color: red; color: white;">SERAGAM</a>
            </div>
          </li>
          <li class="nav-item">
    ...
    <div class="container">
      <div class="row mb-4 pt-5 mb-5">
        <div class="col text-center">
          <h2 style="color: black; font-size: 32px;">Seragam</h2>
          <hr>
        </div>
      </div>
      ...
      <div class="row mb-4">
        <div class="col-md">
          <div class="card">
            <img src="seragam_utama.png" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-text" style="color: black; text-align: center;">Seragam utama TK Telkom Makassar</p>
        ...
        <div class="col-md">
          <div class="card">
            <img src="seragam_olahraga.png" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-text" style="color: black; text-align: center;">Seragam Olahraga TK Telkom Makassar</p>
              <a href="" class="btn btn-primary">Beli</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md">
          <div class="card">
            <img src="seragam_batik.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-text" style="color: black; text-align: center;">Seragam batik perempuan TK Telkom Makassar</p>
              <a href="" class="btn btn-primary">Beli</a>
            </div>
          </div>
        </div>
      ...
      <div class="row mb-4">
        <div class="col-md">
          <div class="card">
            <img src="batik.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-text" style="color: black; text-align: center;">Seragam batik laki-laki TK Telkom Makassar</p>
              <a href="" class="btn btn-primary">Beli</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md">
          <div class="card">
            <img src="seragam_pramuka_perempuan.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-text" style="color: black; text-align: center;">Seragam pramuka perempuan TK Telkom Makassar</p>
              <a href="" class="btn btn-primary">Beli</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md">
          <div class="card">
            <img src="seragam_pramuka_laki-laki.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-text" style="color: black; text-align: center;">Seragam pramuka laki-laki TK Telkom Makassar</p>
              <a href="" class="btn btn-primary">Beli</a>
            </div>
          </div>
        </div>
